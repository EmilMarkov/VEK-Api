use crate::{modules::formatters::dodi_formatter, modules::helpers::format_name, service::torrent::{Torrent, TorrentProvider}};
...
#[async_trait]
impl TorrentProvider for ProviderDODI {
