use crate::{modules::formatters::kaoskrew_formatter, modules::helpers::format_name, service::torrent::{Torrent, TorrentProvider}};
...
#[async_trait]
impl TorrentProvider for ProviderKaOsKrew {
